...
export const hotSingleProducts: HotProduct[] = [
  {
    slug: "coq10-95",
    name: "1970 Uncle Darren's 高含量辅酶Q10胶囊 美国进口专利",
    category: "心臟健康",
    price: 69,
    originalPrice: 199,
    tags: ["辅酶Q10", "心血管", "美国进口"],
    href: "/products/coq10-95",
    emoji: "💊",
    image: "/images/plans/stress.jpg",
  },
  {
    slug: "nmn-60000",
    name: "NMN 60000 细胞能量支持 美国进口原料",
    category: "腦力提升",
    price: 65,
    originalPrice: 180,
    tags: ["NMN", "细胞能量", "美国进口"],
    ...
    emoji: "🧬",
    image: "/images/plans/fatigue.jpg",
  },
  {
    slug: "calcium-complex",
    name: "中老年人钙片 胶原蛋白软骨素复合 骨骼关节营养支持",
    category: "骨骼健康",
    price: 89,
    originalPrice: 220,
    tags: ["钙片", "胶原蛋白", "软骨素"],
    ...
    emoji: "🦷",
    image: "/images/plans/sleep.jpg",
  },
  {
    slug: "probiotic-15",
    name: "15菌株成人复合益生菌 肠道日常营养 消化支持",
    category: "腸道健康",
    price: 89,
    originalPrice: 199,
    tags: ["15菌株", "益生菌", "消化支持"],
    ...
    emoji: "🦠",
    image: "/images/plans/immune.jpg",
  },
  {
    slug: "dha-ps",
    name: "DHA藻油+磷脂酰丝氨酸 成人腦力提升 认知营养支持",
    category: "腦力提升",
    price: 79,
    originalPrice: 180,
    tags: ["DHA", "PS", "记忆力"],
