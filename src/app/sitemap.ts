...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/solutions`, changeFrequency: "weekly", priority: 0.85 },
    ...
    { url: `${SITE_URL}/trust-center`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${SITE_URL}/compliance`, changeFrequency: "yearly", priority: 0.5 },
  ];
