    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        <div className="site-footer-brand">
          ...
          <p>科学评估 · 审慎支持 · 健康相伴</p>
          <p>{contactChannels.supportEmail}</p>
          <p>WhatsApp: {contactChannels.whatsappDisplay}</p>
          <p>
            微信：{contactChannels.wechatId} · {contactChannels.wechatCopyText}
          </p>
        </div>
        <div>
          <h2>产品与服务</h2>
          ...
          <Link href="/products">官网商城（展示与咨询）</Link>
        ...
        <div>
          ...
          {contactChannels.qrImagePath ? (
            <Image src={contactChannels.qrImagePath} alt="微信客服二维码" width={96} height={96} />
          ) : (
            <p>{contactChannels.qrFallbackLabel}：{contactChannels.wechatId}</p>
          )}
        </div>
      </div>
