...
export const articles: Article[] = [
...

  {
    ...
    sections: [
      ...
      {
        heading: "服用方法与剂量",
        content: "①推荐剂量：基于现有研究，有效剂量约100亿-300亿CFU/天（即10^10-10^11 CFU）②服用时间：通常建议早上空腹或睡前，此时胃酸较弱，有利于活菌通过胃部到达肠道③补充周期：肠道菌群调整需要时间，建议至少连续服用8-12周再评估效果，不建议只吃1-2周就判断'没效果'④与抗生素间隔：如果需要服用抗生素，益生菌应在抗生素后2-3小时服用，避免抗生素杀死活菌。",
      },
      {
        heading: "AKK菌可以长期服用吗",
...

  {
    ...
    sections: [
      ...
      {
        heading: "使用建议与注意事项",
        content: "①剂量：研究有效的剂量通常在10-100亿CFU/天，不要只看'菌数'，更要看菌株和临床证据②服用时间：随餐或餐后30分钟内服用，利用胃酸较弱时段提高活菌率③补充周期：益生菌需要时间定植，通常需要连续服用8-12周才能建立稳定菌群，不建议只吃1-2周就放弃④保存：大部分益生菌需要冷藏，开封后注意防潮防热⑤抗生素期间：服用抗生素后2-3小时补充益生菌，减少抗生素对肠道菌群的破坏。",
      },
      {
        heading: "与哪些成分协同",
...

  {
    ...
    sections: [
      ...
      {
        heading: "注意事项",
        content: "①过量风险：长期高剂量锌（>100mg/天）可能导致铜缺乏（锌干扰铜的吸收）、恶心、腹泻、免疫功能抑制②药物相互作用：锌可能与某些抗生素（喹诺酮类、四环素类）结合，降低抗生素效果——应间隔2小时服用③感冒时补充：研究显示感冒初期高剂量锌（醋酸锌或葡萄糖酸锌含片，75-100mg/天，补充周期<5天）可能缩短感冒持续时间，但不建议长期使用高剂量。",
      },
    ],
    relatedPlan: "immune",
    recommendation: {
