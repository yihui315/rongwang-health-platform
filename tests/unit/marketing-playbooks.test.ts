...
function analyticsSummary(input: Partial<AnalyticsSummary> = {}): AnalyticsSummary {
  return {
    total: 0,
    byName: {
      home_protocol_viewed: 0,
      home_protocol_cta_clicked: 0,
      protocol_hero_view: 0,
      protocol_hero_primary_click: 0,
      protocol_hero_report_sample_click: 0,
      protocol_hero_unknown_click: 0,
      medical_review_strip_view: 0,
      health_review_standard_click: 0,
      chief_complaint_selector_view: 0,
      chief_complaint_unknown_click: 0,
      chief_complaint_sleep_click: 0,
      chief_complaint_fatigue_click: 0,
      chief_complaint_alcohol_click: 0,
      chief_complaint_immunity_click: 0,
      chief_complaint_female_click: 0,
      chief_complaint_male_click: 0,
      assessment_router_loaded: 0,
      assessment_scenario_preselected: 0,
      assessment_scenario_changed: 0,
      assessment_privacy_view: 0,
      assessment_report_consent_checked: 0,
      assessment_marketing_opt_in_checked: 0,
      assessment_consent_continue_click: 0,
      chief_complaint_selector_viewed: 0,
      chief_complaint_selected: 0,
      assessment_started: 0,
      assessment_completed: 0,
      result_low_view: 0,
      result_medium_view: 0,
      result_high_view: 0,
      result_solution_click: 0,
      result_report_save_click: 0,
      high_risk_summary_email_click: 0,
      high_risk_care_guide_download: 0,
      reassessment_reminder_requested: 0,
      product_passport_preview_view: 0,
      product_passport_assessment_cta_click: 0,
      product_suitability_cta_click: 0,
      product_evidence_click: 0,
      product_cta_hidden_high_risk: 0,
      product_purchase_ready_click: 0,
